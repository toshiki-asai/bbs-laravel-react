...
return [
    ...
    */
    ...
    'confirmed' => ':attribute フィールドの確認用入力が一致しません。',
    ...
    'max' => [
        'array' => ':attribute フィールドの項目数は :max 個以下である必要があります。',
    ...
    'min' => [
        'array' => ':attribute は、少なくとも :min 個の要素を含む必要があります。',
        'file' => ':attribute は、少なくとも :min キロバイトである必要があります。',
        'numeric' => ':attribute は、少なくとも :min である必要があります。',
        'string' => ':attribute は、少なくとも :min 文字である必要があります。',
    ],
    ...
    'password' => [
        ...
        'mixed' => ':attribute には少なくとも1つの大文字と小文字を含める必要があります。',
